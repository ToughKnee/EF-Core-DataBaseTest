...
public class Team : AggregateRoot<TeamName>
{
    ...
    public void AddPLayer(Player player)
    {
        ...
        // Now when we implement the inheritance, we can use with more ease the entities and aggregates, because there is an overload of the equal that is defined from the inheritance
